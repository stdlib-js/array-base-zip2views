...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/array-base-zip2views/tags). For example,

```javascript
zip2views = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-zip2views@v0.1.1-umd/browser.js' )
```
